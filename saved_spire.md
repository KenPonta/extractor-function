# Spire extraction: saved.pptx

- **slides:** 16
- **title:** Panel TFP Project Slide
- **author:** 
- **last_saved_by:** pontakorn kangvanwanich

## Slide 1

`[image: image/png 369x88]`

`[image: image/png 2304x1296]`
...
> ⚠️ **WATERMARK:** Evaluation Warning : The document was created with Spire.Presentation for Python
...
`[image: image/png 2716x127]`

`[image: image/png 2716x72]`
...
`[image: image/png 1044x624]`

TFP Trajectories — Calibrated α = 1/3

`[image: image/png 1218x734]`
