...
- Indonesia and Brunei maintain the highest "lny" values (around 11-12) and appear steady with slight increases over time.
- Malaysia and Singapore are just above 10 on "lny" and relatively stable.
- Thailand and Philippines remain in the 9-10 "lny" range, with a gentle upward trend.
- Myanmar, Lao, and Vietnam are in the 8-9 "lny" range, with gradual increases.
- Cambodia starts below 8 in 2000 and trends upward, nearing 8.5 by 2025.
- General trend: All countries show a gradual increase in "lny" from 2000 to 2025.
...
Where:
- K₀ is on the left side of the equation.
- l₀ is the numerator.
- (g + δ) is the denominator.
...
X-Axis Range: -2.5 to 2.5 (approximate)

Data (Estimated α vs Calibrated α, approximate locations based on bar ends):
...
- Brunei has negative α values.
- For most countries, the Estimated α and Calibrated α values are the same or very close, except Cambodia (where Calibrated α is higher than Estimated α).
...
Trends/Relationships:
- SGP and BRN are the highest in Log TFP values throughout the period, with SGP slightly above BRN.
- MYS follows below, with steady growth over the timeframe.
- Other countries (THA, IDN, PHL, LAO, KHM, VNM) have lower Log TFP and also show gradual increases.
- BRN has a slight downward trend, while most other countries either rise slowly or remain relatively stable. 
- Log TFP gaps between countries are persistent over time.
...
X-axis: Year (range: 2000 to 2025)
Y-axis: Log TFP (range: approx. 5.5 to 8.2)
...
Trends/Relationships:
- SGP (dark blue) and BRN (light blue) have the highest Log TFP, with SGP consistently leading.
- Lower group (KHM, LAO, VNM) starts below 6 and shows gradual increases over time.
- Middle performers (IDN, PHL, MYS, THA) show moderate upward trends from 2000 to 2025.
- All countries show generally upward or stable trends in Log TFP over the years.
...
Trend/Relationship:
- As Initial TFP (2000) increases, Cumulative TFP Growth (2000-2023) generally decreases.
